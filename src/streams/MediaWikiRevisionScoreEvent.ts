...
export default interface MediaWikiRevisionScoreEvent
	extends MediaWikiEvent, Page, Comment,
		Pick<Revision, 'rev_id' | 'rev_parent_id' | 'rev_timestamp'> {
 ...
 * @param object
 */
export function isMediaWikiRevisionScoreEvent( object: any ):
